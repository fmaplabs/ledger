...
foldTime is a tool for commit based time tracking for freelance software developers. It's conceptually similar to tools
like wakatime. 
...
2. foldTime should have an editor integration plugin (neovim).
